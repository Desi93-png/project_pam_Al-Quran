...
class DetailScreen extends StatelessWidget {
  ...
  // Paket Dio untuk membuat request HTTP, mengambil data. Pakai API
            ...
            body: NestedScrollView(
              ...
              body: Padding(
                ...
                child: ListView.separated(
                  ...
                  // Kalau no surat = 1 (Al-Fatihah) maka ayat dikurangi 1 karena sudah ada Bismillah (biar ngga double)
  ...
  Widget _ayatItem({required Ayat ayat}) => Padding(
        ...
        child: Column(
          ...
          children: [
            // Untuk card/background ayat dan icon2
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
              decoration: BoxDecoration(
                  color: gray, borderRadius: BorderRadius.circular(10)),
              // Row karena ayat dan icon2nya horizontal
              child: Row(
                children: [
                  Container(
                    width: 27,
                  ...
                  const Spacer(),
                  // Yang icon share dari material icon
                  const Icon(
